...
import com.codecool_mjs.controller.webAccessController.studentActionController.*;
...
public class ServerController {
    ...
    public void createAndStartSever() throws IOException {
        ...
        server.createContext("/account/read", new ShowUserDataActions());
        server.createContext("/account/edit", new EditUserActions());
        server.createContext("/quests/read", new ShowQuestsActions());
        ...
        server.createContext("/artifact/buy", new BuyArtifactsActions());
