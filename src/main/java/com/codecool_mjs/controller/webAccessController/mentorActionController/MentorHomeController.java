...
public class MentorHomeController extends WebActionController implements Sessionable {

    private static String DATA_TEMPLATE_URL = "/mentor/mentor-home";

    public MentorHomeController(){
        super();
    }

    private String showMentorHomePage() throws DaoException {
