...
public class DeleteQuestActions implements HttpHandler{
    ...
    public void handle(HttpExchange httpExchange) throws IOException {
        ...
        if(method.equals("GET")) {
            ...
            responseBody = showQuestToDelete(id);
        }
    ...
    private String showQuestToDelete(Integer id){
        ...
        String page = templateProcessor.ProcessTemplateToPage("mentor/delete-quest");
        return page;
    }
